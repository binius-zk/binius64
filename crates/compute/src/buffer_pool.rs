...
/// The smallest block worth backing with huge pages.
///
/// A transparent huge page is 2 MiB.
///
/// Advising a smaller block can never be honoured, so the request is skipped below this size.
