...
//! operations. After the inner proof is run through the channel, [`finish`] replays the recorded
//! gate sequence to fill the outer witness, then runs the outer IOP prover.
//!
