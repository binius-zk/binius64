...
/// Candidate inverse rates, matching the sweep `binius_iop::fri::RateEstimate::sweep` prices.
const LOG_INV_RATES: [usize; 6] = [1, 2, 3, 4, 5, 6];

/// Benchmarks [`ReedSolomonCode::encode_batch`] at each candidate Reed-Solomon rate.
///
/// This is the prover-cost half of the trade-off `binius_iop::fri::RateEstimate::sweep` prices.
