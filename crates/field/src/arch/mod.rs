...
cfg_if! {
	if #[cfg(all(target_arch = "x86_64"))] {
		...
		pub use x86_64::packed_ghash_128::{GhashWideMul1x, GhashSquare1x, GhashInvert1x, GhashPreparedMul1x};
		pub use x86_64::packed_ghash_256::{GhashWideMul2x, GhashSquare2x, GhashInvert2x, GhashPreparedMul2x};
		pub use x86_64::packed_ghash_512::{GhashWideMul4x, GhashSquare4x, GhashInvert4x, GhashPreparedMul4x};
		...
		pub use aarch64::packed_ghash_128::{GhashWideMul1x, GhashSquare1x, GhashInvert1x, GhashPreparedMul1x};
		pub use portable::{packed_aes_256, packed_aes_512, packed_ghash_256, packed_ghash_512};
		pub use portable::packed_ghash_256::{GhashWideMul2x, GhashSquare2x, GhashInvert2x, GhashPreparedMul2x};
		pub use portable::packed_ghash_512::{GhashWideMul4x, GhashSquare4x, GhashInvert4x, GhashPreparedMul4x};
		...
		pub use wasm32::packed_ghash_128::{GhashWideMul1x, GhashSquare1x, GhashInvert1x, GhashPreparedMul1x};
		...
		pub use portable::packed_ghash_128::{GhashWideMul1x, GhashSquare1x, GhashInvert1x, GhashPreparedMul1x};
		pub use portable::packed_ghash_256::{GhashWideMul2x, GhashSquare2x, GhashInvert2x, GhashPreparedMul2x};
		pub use portable::packed_ghash_512::{GhashWideMul4x, GhashSquare4x, GhashInvert4x, GhashPreparedMul4x};
		pub use portable::packed_ghash_sq_256::GhashSqWideMul1x;
		pub use portable::packed_aes_128::{AesWideMul16x, AesSquare16x, AesInvert16x};
